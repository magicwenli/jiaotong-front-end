 ...
 * @LastEditTime : 2021-07-08 20:01:18
 * @Description  : 
      ...
      <form class="mt-6 space-y-4" action="#" method="POST">
        ...
        <div class="rounded-md shadow-sm -space-y-px">
          ...
          <div>
            ...
            <input id="su-re-password" name="password" type="password" autocomplete="current-password" required="" class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Retype Password" />
          </div>
        </div>

        <div class="mt-2">
          <label for="nickname" class="sr-only">Nickname</label>
          <input id="su-nickname" name="nickname" type="text" autocomplete="username" required="" class="appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Nickname" />
        </div>
